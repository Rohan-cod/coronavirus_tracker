# Coronavirus Tracker
A web app made using django framework to get latest updates on coronavirus in India everyday.
...
## Setting up the Project
  ...
  * Fork the Repository.
  * Clone the repository to your local machine `$ git clone https://github.com/<your-github-username>/coronavirus_tracker.git`
  * Change directory to coronavirus_tracker `$ cd coronavirus_tracker`
